...
export default function LoginClient({ authenticationError }: { authenticationError: boolean }) {
  const supabase = createClient()
  const [currentImage, setCurrentImage] = useState(0)
  const [error, setError] = useState(authenticationError ? 'Sign-in could not be completed. Please try again.' : '')
