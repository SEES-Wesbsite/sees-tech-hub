...
export default function SubmitHackathonPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 pt-24 pb-20 overflow-x-hidden text-slate-900">
        ...
        {isSuccess ? (
          ...
          <div className="lg:col-span-2">
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="p-6 md:p-8 bg-white border border-slate-200 rounded-2xl shadow-sm">
                <h3 className="text-xl font-bold mb-2 text-slate-900">Upload Concept Note</h3>
